 ...
 ***************************************************************************/
PID::PID(double _kp, double _ki,
         double _kd, int _pOn, int _ControllerDirection)
{
  ...
  PID::SetControllerDirection(_ControllerDirection);
  PID::SetTunings(_kp, _ki, _kd, _pOn);
...
/*Constructor (...)*********************************************************
 *    To make PID use internal inputs outputs (for cleaner code?)
 ***************************************************************************/
// PID::PID(double Kp, double Ki, double Kd, int POn, int ControllerDirection)
//     : PID::PID(&this->Input, &this->Output, &this->Setpoint, Kp, Ki, Kd, POn,
//                ControllerDirection) {}
 ...
 ******************************************************************************/
void PID::SetTunings(double _kp, double _ki, double _kd, int _pOn)
{
